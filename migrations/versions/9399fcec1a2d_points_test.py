...
Revision ID: 9399fcec1a2d
Revises: 
Create Date: 2019-11-19 21:31:34.100392
...
def upgrade():
    ...
    op.create_index(op.f('ix_user_total_points'), 'user', ['total_points'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_user_total_points'), table_name='user')
